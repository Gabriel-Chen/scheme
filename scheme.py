...
class PrimitiveProcedure(Procedure):
    ...
    def apply(self, args, env):
        ...
        try:
            ...
            raise SchemeError('the wrong number of args were passed.')
        # END PROBLEM 4
...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        check_form(first, 2, 2)
        formals = Pair(first.first, formals)
        vals = Pair(scheme_eval(first.second.first, env), vals)
